...
1.  **Výběr názvu:** Vyberete si název projektu a zaznamenáte ho do hlavní tabulky v souboru `README.md` v kořeni repozitáře.
...
> [!IMPORTANT]
> Než začnete pracovat na samotném kódu projektu, musíte si vybrat jeho název a popsat jej v souborech `README.md` a `[nazev]_projekt.md`.
...
Dokumentace bude obsahovat následující informace:
*   **Název projektu**, na kterém pracujete.
*   **Popis a cíl projektu.**
*   **Popis funkcionality programu.**
*   **Technická část:** použité knihovny, algoritmy, vlastní datové struktury, nebo volání externího API atd.
